...
class Download(Base):
    ...
    resolved_url = Column(String, nullable=True)  # actual file URL
    filename = Column(String, default="")
    status = Column(String, default="pending")    # pending|queued|downloading|paused|completed|failed
...
def init_db():
    ...
    db = SessionLocal()
    try:
        # Reset any stuck downloads from a previous run
